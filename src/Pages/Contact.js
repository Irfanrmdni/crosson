                    ...
                    <div className="w-full mt-14 flex flex-row items-center justify-between gap-x-5">
                        <div className="w-4/12 bg-white shadow-md py-2 px-7">
                            ...
                            <div className="mt-7 mb-4 flex flex-row items-center">
                                <Button href="/">Get Direction</Button>
                                <Link to="/" className="ml-4 text-base underline tracking-wide">See on Map</Link>
                            </div>
                        </div>
                        <div className="w-4/12 bg-white shadow-md py-2 px-7">
                            <div className="my-4">
                            ...
                            <div className="mt-7 mb-4 flex flex-row items-center">
                                <Button href="/">Request Form</Button>
                            </div>
                        </div>
                        <div className="w-4/12 bg-white shadow-md py-2 px-7">
                            <div className="my-4">
